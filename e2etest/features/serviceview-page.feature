# ../features/serviceview-page.feature

Feature: Service view Page Test
  As a normal user,
  I am able to browse the service view page of the security request system

  Scenario: Browse the service view page of the security request system
    Given I am at the service view page of the security request system
    Then I should see the service view page and background image
