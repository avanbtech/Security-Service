# ../features/exportdata-page.feature

Feature: Export Data Page Test
  As a normal user,
  I am able to browse the export data page of the security request system

  Scenario: Browse the export data page of the security request system
    Given I am at the export data page of the security request system
    Then I should see the export data page and background image
